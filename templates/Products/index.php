    ...
    <div class="products form content">
            ...
            <fieldset>
                <?php
                   ...
                   echo $this->Form->control('category_id',['options' => $categories, 'empty' => 'Show all categories']);
                ?>
            </fieldset>
            <?= $this->Form->button(__('Search by above criteria')) ?>
            <?= $this->Html->link(__('Reset search and list all products'), ['action' => 'index'], ['class' => 'button float-right']) ?>
            <?= $this->Form->end() ?>
        </div>
        <table>
            <thead>
